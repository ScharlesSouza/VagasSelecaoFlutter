...
class EmpresaPage extends StatefulWidget {
  ...
  static String tag = '/empresaListar';
  final String title;
...
class _EmpresaPageState extends State<EmpresaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: StreamBuilder(
            stream: empresas.where('').orderBy('razaoSocial').snapshots(),
            builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, int i) {
                    var empresa = snapshot.data!.docs[i];
                    return ListTile(
                          ...
                          showDialog(
                              ...
                              builder: (BuildContext ctx) {
                                return AlertDialog(
                                  ...
                                  content: Text(
                                      'Esta ação irá remover a empresa selecionada'),
                                  actions: [
                                    RaisedButton(
                                      onPressed: () {
                                    ...
                                    RaisedButton(
                                      onPressed: () {
                                        empresas.doc(empresa.id).delete();
                                        Navigator.of(ctx).pop();
                      ...
                      title: Text(
                          empresa['razaoSocial']), //empresa.data().toString()
                      subtitle: Text(
                          "Area de Atuação: " + empresa.get('areaAtuacao')),
                      onLongPress: () => {},
                      onTap: () {
                        showDetail(empresa);
                      },
  ...
  void showDetail(QueryDocumentSnapshot<Object?> empresa) {
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => DetailPageEmpresa(empresa)));
  }
}
